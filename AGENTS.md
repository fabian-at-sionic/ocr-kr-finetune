...
Warning: The workspace is constrained to a single container with an effective memory/GPU-resource ceiling of **267.7 GB** and a dataset-storage cap of **700 GB** under `/workspace/ocr-bench/dataset`.
